...
export default function Layout() {
  ...
  return (
    <div className="flex h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-50 overflow-hidden font-sans transition-colors">
      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <FriendsSidebar activeUsers={activeUsers} />
        </div>
      </div>
    </div>
  );
